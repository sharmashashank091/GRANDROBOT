...
TECHNO_IMG = "https://telegra.ph/file/12b584c86bd045243c960.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/Swage_Boy0")],
                                                                                   [InlineKeyboardButton(text="ADD SPIDER DEVIL TO YOUR GROUP",
        ...
        update.effective_message.reply_text("MAI ZINDA HUU SABAB")
